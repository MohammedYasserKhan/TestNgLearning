...
import pageFactory.login.QuoteEPFileandTranslateNoClaims;
import utility.EReport;

public class QuoteEPFileandTranslateNoClaimsTesting extends EReport
{
...
public WebDriver driver;
	...
	public void QuoteEPFileandTranslateNoClaimsTesting1() throws InterruptedException, AWTException
	{
		
		test=extent.createTest("Quote EP Grant file and translate test");
		QuoteEPFileandTranslateNoClaims D2 = new QuoteEPFileandTranslateNoClaims(MyDriver.driver);
