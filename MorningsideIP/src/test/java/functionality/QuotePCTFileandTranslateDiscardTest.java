...
import pageFactory.login.QuotePCTFileandTranslateDiscard;
import utility.EReport;

public class QuotePCTFileandTranslateDiscardTest extends EReport
{
	@Test(priority=2)
	public void QuotePCTFileandSubmissionSaveTesing() throws InterruptedException, AWTException
	{
		
		test=extent.createTest("Quote EP Grant file and translate test");
		QuotePCTFileandTranslateDiscard D2 = new QuotePCTFileandTranslateDiscard(MyDriver.driver);
		...
		{
			System.out.println("================================================================");
			System.out.println("Step 10 : Saving Quote");
