...
import pageFactory.login.QuotePCTFileandSubmissionSave;
import utility.EReport;

public class QuotePCTFileandSubmissionSaveTest extends EReport
{
	@Test(priority=2)
	public void QuotePCTFileandSubmissionSaveTesing() throws InterruptedException, AWTException
	{
		...
		QuotePCTFileandSubmissionSave D2 = new QuotePCTFileandSubmissionSave(MyDriver.driver);
