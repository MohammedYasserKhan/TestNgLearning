...
import pageFactory.login.QuoteEpGrantsubmission;
import utility.EReport;

public class QuoteEpGrantsubmissionTest extends EReport 
{
...
public WebDriver driver;
	...
	public void EPQuoteSubmissionTesting() throws InterruptedException, AWTException
	{
		...
		QuoteEpGrantsubmission D2 = new QuoteEpGrantsubmission(MyDriver.driver);
		System.out.println("now moved to Quote ");
		
		if(D2.QuoteEpfileandtranslate_1())
		{
		...
		if(D2.QuoteEpfileandtranslatecontinue_1())
		{
			System.out.println("================================================================");
		...
		if(D2.QuoteEpfileandtranslatecontinue_11())
		{
			System.out.println("================================================================");
