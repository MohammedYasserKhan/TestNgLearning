...
import pageFactory.login.QuoteEpgrantTemplate;
import utility.EReport;

public class QuoteEpgrantTemplateTest extends EReport 
{

	@Test(priority=2)
	public void  QuoteEpgrantTemplateTesting() throws InterruptedException, AWTException
	{
		
		test=extent.createTest("Quote EP Grant file and translate test");
		QuoteEpgrantTemplate D2 = new QuoteEpgrantTemplate(MyDriver.driver);
