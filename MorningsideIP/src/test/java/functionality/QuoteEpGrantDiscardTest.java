...
import pageFactory.login.QuoteEpGrantDiscard;
import utility.EReport;

public class QuoteEpGrantDiscardTest extends EReport
{
	@Test(priority=2)
	public void QuoteEpGrantDiscardTesting() throws InterruptedException, AWTException
	{
		
		test=extent.createTest("Quote EP Grant file and translate test");
		QuoteEpGrantDiscard D2 = new QuoteEpGrantDiscard(MyDriver.driver);
		...
		{
			System.out.println("================================================================");
			System.out.println("Step 11 : discard quote");
