...
import pageFactory.login.QuoteEPtranslationsubmission;
import utility.EReport;

public class QuoteEptranslationsubmissionTest extends EReport
{
	@Test(priority=2)
	public void EPQuoteSubmissionTesting() throws InterruptedException, AWTException
	{
		...
		QuoteEPtranslationsubmission D2 = new QuoteEPtranslationsubmission(MyDriver.driver);
		...
		if(D2.quotesubmission())
		{
			System.out.println("================================================================");
			System.out.println("Step 10 : quote submission");
			Reporter.log("Quote Submission");
			test.log(com.aventstack.extentreports.Status.PASS,"Success");
		}
		else
		{
			System.out.println("================================================================");
			System.out.println("quote submission failed");
			Reporter.log("Quote submission failed"); 
