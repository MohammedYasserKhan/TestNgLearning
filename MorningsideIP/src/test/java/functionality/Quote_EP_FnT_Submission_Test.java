...
import pageFactory.login.Quote_EP_FnT_Submission;
import utility.EReport;
import utility.SeleniumFunctions;

public class Quote_EP_FnT_Submission_Test extends EReport 
{
	...
	public void Epquotesubmissiontesting() throws InterruptedException, AWTException
	{
		...
		Quote_EP_FnT_Submission quote = new Quote_EP_FnT_Submission();
