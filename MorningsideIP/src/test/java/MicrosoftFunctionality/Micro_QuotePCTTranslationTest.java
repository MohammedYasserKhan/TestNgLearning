...
import MicrosoftPageFactory.login.Micro_QuotePCTTranslationsubmission;
import pageFactory.login.MyDriver;
import utility.EReport;

public class Micro_QuotePCTTranslationTest extends EReport
{
	@Test
	public void Micro_QuotePCTTranslationTesting() throws InterruptedException, AWTException
	{
		test=extent.createTest("Quote EP Grant file and translate test");
		Micro_QuotePCTTranslationsubmission QPCT = new Micro_QuotePCTTranslationsubmission(MyDriver.driver);
		System.out.println("================================================================");
		...
		{
			System.out.println("================================================================");
			System.out.println("Step 10 : approving Quote");
