...
import MicrosoftPageFactory.login.Micro_QuotePCTSubmissionsave;
import pageFactory.login.MyDriver;
import utility.EReport;

public class Micro_QuotePCTTranslationSaveTest extends EReport
{
	@Test
	public void Micro_QuotePCTTranslationSaveTesting() throws InterruptedException, AWTException
	{
		...
		Micro_QuotePCTSubmissionsave QPCT = new Micro_QuotePCTSubmissionsave(MyDriver.driver);
		System.out.println("================================================================");
