...
public class QuoteEpTranslationsubmisisonTemplate 
{
	public WebDriver driver;
//	JavaHelpers JH = new JavaHelpers();
	SeleniumFunctions SeleniumFunc = new SeleniumFunctions(driver);
	
	public QuoteEpTranslationsubmisisonTemplate(WebDriver driver)
	{
	...
	public boolean template() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		templatename.click();
		templatename.sendKeys(Constants.Templatename);
		Thread.sleep(2000);
		templateok.click();
